...
public class EditorActivity extends AppCompatActivity {
    ...
    private void setDataFromIntentExtra() {
        ...
        if (id != 0) {
            ...
            getSupportActionBar().setTitle("Add a Plant");
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_delete:
                ...
                dialog.setMessage("Delete this plant?");
    ...
    private void postData(final String key) {
        ...
        Call<Plants> call = apiInterface.insertPlants(key, name, species, breed, gender, birth, picture);
    ...
    private void updateData(final String key, final int id) {
        ...
        Call<Plants> call = apiInterface.updatePlants(key, id,name, species, breed, gender, birth, picture);
    ...
    private void deleteData(final String key, final int id, final String pic) {
        ...
        Call<Plants> call = apiInterface.deletePlants(key, id, pic);
